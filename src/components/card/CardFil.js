    ...
    return (
      <Wrapper>
        <div className="top-card">
          <img src={process.env.REACT_APP_API_URL + '/' + this.props.photo} style={{width: 50, height: 50}} alt="profile" />
        ...
        <div className="card-btn">
          <Link className="card-btn-item" to="#" onClick={this.handleShowPromote}>
            Promote
          </Link>
